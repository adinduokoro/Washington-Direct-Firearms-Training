      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <h2 className={styles.title}>
            COMPREHENSIVE{" "}
            <span className={styles.highlight}>TRAINING SERVICES</span>
          </h2>
          <p className={styles.description}>
            From basic safety to advanced tactical operations, we provide
            specialized training programs designed to meet your specific needs
            and skill level.
          </p>
        </div>
        ...
        <div className={styles.ctaBox}>
          ...
          <p className={styles.ctaText}>
            Our experienced instructors will help you choose the perfect
            training program based on your goals and experience level.
          </p>
